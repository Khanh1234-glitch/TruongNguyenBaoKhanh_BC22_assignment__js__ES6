...
for (let value of colorList) {
    ...
    const fn = () => {
        let button1 = "<button class= 'color-button pallet'></button>";
        let button2 = "<button onclick='changeColor()' class= 'color-button varidian active'></button>";
...
const changeColor = () => {
    document.getElementsByClassName("cerulean")[0].addEventListener("click", () => {
        document.getElementById("house-roof").style.backgroundColor = "cerulean";
    })
}
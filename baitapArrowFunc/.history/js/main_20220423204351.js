...
for (let value of colorList) {
    ...
    const fn = () => {
        ...
        let button2 = "<button onclick='changeColorvaridian()'  class= 'color-button varidian '></button>";
...
const changeColor = () => {
    var result = document.getElementsByClassName("house-roof")[0];
    result.style.color = "pallet";
}
const changeColorvaridian = () => {
    var result = document.getElementById("house-roof")[0];
    result.style.color = "varidian";
}